...
public interface CanBendHook {
     ...
     * @param bender The player being checked
     ...
     */
    @NotNull
    Optional<Boolean> canBend(@NotNull Bender bender, @NotNull CoreAbility ability, boolean isCheckingBind, boolean isCheckingCooldown);
}
